...
INSERT INTO `observacion` (`id_observacion`,`id_detalle_esquema`,`id_revision`,`observacion`,`fecha`,`fecha_act`,`estado`) VALUES 
 ...
 (10,13,16,'FUNDAMENTAR SU DISCUSION','2015-06-11 04:34:44',NULL,7);
...
INSERT INTO `revision` (`id_revision`,`id_asignacion`,`comentario`,`fecha`,`estado`) VALUES 
 (13,3,'OBSERVAICON FINAL','2015-06-10 07:07:20',12),
 (14,5,'LEVANTAR LAS OBSERVACIONES Y VOLVER A ENVIAR','2015-06-10 07:22:44',12),
 (15,7,'SIN OBSERVACIONES','2015-06-11 04:02:50',11),
 (16,8,'REALIZAR CORRECCIONES Y REENVIAR','2015-06-11 04:34:27',12);
...
INSERT INTO `tesis` (`id_tesis`,`id_autor`,`id_recepcionista`,`id_linea`,`id_esquema`,`titulo`,`fecha_sustentacion`,`fecha_registro`,`estado`) VALUES 
 ...
 (9,44,39,5,1,'LA TESIS DE CALIDAD Y SERVICIO','2014-11-27','2015-06-11 04:32:35',4);
...
INSERT INTO `tesis_recepcion` (`id_tesis_recepcion`,`id_tesis`,`id_recepcionista`,`id_director`,`fecha_recepcion`,`estado`) VALUES 
 ...
 (6,6,1,4,'2015-06-03 03:18:28',4),
 (7,7,1,9,'2015-06-03 13:28:19',3),
 (8,8,1,15,'2015-06-03 20:36:07',12),
 (9,9,39,4,'2015-06-11 04:32:35',5);
...
update tesis_recepcion set estado = 11 where id_tesis_recepcion = @recep;
