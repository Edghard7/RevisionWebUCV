...
INSERT INTO `observacion` (`id_observacion`,`id_detalle_esquema`,`id_revision`,`observacion`,`estado`) VALUES 
 (1,1,5,'obs 1',7),
 (2,2,5,'obs 2',7),
 (3,3,5,'obs 3',7);
...
CREATE TABLE `revision` (
  ...
  `estado` int(11) NOT NULL DEFAULT '12',
...
INSERT INTO `revision` (`id_revision`,`id_asignacion`,`comentario`,`fecha`,`estado`) VALUES 
 (13,3,'OBSERVAICON FINAL','2015-06-10 07:07:20',11),
 (14,5,'SOLO CORRIJA LA CARATULA Y EMPASTE :)','2015-06-10 07:22:44',12);
...
INSERT INTO `tesis` (`id_tesis`,`id_autor`,`id_recepcionista`,`id_linea`,`id_esquema`,`titulo`,`fecha_sustentacion`,`fecha_registro`,`estado`) VALUES 
 (1,33,5,1,1,'INFLUENCIA DE LA UTILIZACION DE UN ........ ','2014-11-24','2015-06-02 23:05:47',3),
 (2,33,5,1,1,'INFLUENCIA DE LA UTILIZACION DE UN LIBRO. ','2014-11-24','2015-06-02 23:34:38',4),
 (3,38,1,10,1,'DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY DISEÑO DE UN XX YY ESPERANDO QUE ESTO SE CORTE ---------....','2014-11-24','2015-06-03 02:47:53',4),
 ...
 (8,40,1,12,1,'TESIS DEL ESQUEMA CUANTTATIVO DE LA ESCELA DE ADMINISTRACIÓN','2014-11-19','2015-06-03 20:36:07',3);
...
INSERT INTO `tesis_recepcion` (`id_tesis_recepcion`,`id_tesis`,`id_recepcionista`,`id_director`,`fecha_recepcion`,`estado`) VALUES 
 (1,2,5,4,'2015-06-02 23:34:38',4),
 (2,2,5,4,'2015-06-02 23:36:45',4),
 (3,3,1,4,'2015-06-03 02:47:53',5),
 (4,4,1,15,'2015-06-03 02:53:50',12),
 (5,5,1,9,'2015-06-03 03:16:16',5),
 (6,6,1,4,'2015-06-03 03:18:28',3),
 (7,7,1,9,'2015-06-03 13:28:19',3),
 (8,8,1,15,'2015-06-03 20:36:07',3);
...
SELECT a.id_asignacion, a.id_tesis_recepcion, t.id_tesis,
...
order by a.fecha_asignacion, tr.fecha_recepcion, t.titulo;
...
INNER JOIN escuela es ON l.id_escuela = es.id_escuela
-- LEFT JOIN estado est ON tr.estado = est.id_estado
...
update revision set comentario = upper(comentario_i), estado = 11
...
update tesis_recepcion set estado = 5 where id_tesis_recepcion = @recep;
